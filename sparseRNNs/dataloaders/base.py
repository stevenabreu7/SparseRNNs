...
default_data_path = os.environ.get("DEFAULT_DATA_PATH", None)
assert default_data_path is not None, (
    "Please set the DEFAULT_DATA_PATH environment variable to the path where"
    " data is stored."
)
default_data_path = Path(default_data_path)

default_cache_path = os.environ.get("DEFAULT_CACHE_PATH", None)
assert default_cache_path is not None, (
    "Please set the DEFAULT_CACHE_PATH environment variable to the path where"
    " cache is stored."
)
default_cache_path = Path(default_cache_path)
